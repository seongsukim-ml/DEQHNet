        ...
        **deq_kwargs,
        ...
        for i in range(self.num_gnn_layers):
            self.self_ham_attention.append(
                HamiltonianAttention(self.ham_hidden, self.head_dim, self.num_heads)
            )
        ...
        # self.hidden_irrep_dim = 20*self.ham_dim
        ...
        #     nn.Linear(self.ham_hidden, self.hidden_irrep_dim),
        # )
        # self.ham_decoder_self_key = nn.Linear(self.ham_hidden, self.hidden_irrep_dim)
        # self.ham_decoder_self_query = nn.Linear(self.ham_hidden, self.hidden_irrep_dim)
        # self.ham_decoder_pair_key = nn.Linear(self.ham_hidden, self.hidden_irrep_dim)
        # self.ham_decoder_pair_query = nn.Linear(self.ham_hidden, self.hidden_irrep_dim)
