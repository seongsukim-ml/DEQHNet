...
class SO2ConvNetLayer(torch.nn.Module):
    def __init__(
        ...
        # self.irreps_readout = o3.FullyConnectedTensorProduct(
        #     self.irrep_hidden, self.irrep_hidden, self.irreps_out
        # )
        # self.irreps_readout = Linear(
